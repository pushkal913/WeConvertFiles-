...
for (const tool of tools) {
  ...
  check(html.includes('<script src="/js/catalogue.js?v=20260824-3"></script>'), `${tool.id}: missing runtime catalogue script`);
  check(html.includes('<script src="/layout.js?v=20260828-1" defer></script>'), `${tool.id}: missing deferred shared shell script`);
  check(html.includes('<script src="/app.js?v=20260824-6" defer></script>'), `${tool.id}: missing deferred shared app script`);
